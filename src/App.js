...
function App() {
  ...
  // Updated Color Scheme - Modern & Professional
  const colors = {
    primary: "#2b2d42",       // Dark navy
    secondary: "#8d99ae",     // Soft gray-blue
    accent: "#ef233c",        // Vibrant red
    accentLight: "#edf2f4",   // Light background
    accentDark: "#d90429",    // Darker red
    success: "#2ec4b6",       // Teal
  ...
  // Filtered data logic remains exactly the same
  // ... (keep your filteredSales and filteredFabric useMemo hooks)
              ...
              <div key={key}>
                ...
                <select
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    appearance: "none",
                    backgroundImage: `url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='${encodeURIComponent(colors.textDark)}' stroke-width='2'%3e%3cpolyline points='6 9 12 15 18 9'%3e%3c/polyline%3e%3c/svg%3e")`,
