                  ...
                  <tbody>
                    {filteredSales.length === 0 ? (
                      ...
                      filteredSales.map((row, i) => (
                        <tr key={i}>
                          <td className="image-cell" style={{padding: 0}}>
                            {row.IMAGE ? (
                              <div 
                                ...
                                style={{height: '100%'}}
                              >
                                <a href={row.IMAGE} target="_blank" rel="noopener noreferrer" style={{display: 'block', height: '100%'}}>
                                  <img
                          ...
                          <td className="image-cell" style={{padding: 0}}>
                            {getMatchingSalesImage(row["ORDER REF"]) ? (
                              <div 
                                ...
                                style={{height: '100%'}}
                              >
                                <a href={getMatchingSalesImage(row["ORDER REF"])} target="_blank" rel="noopener noreferrer" style={{display: 'block', height: '100%'}}>
                                  <img
                          ...
                          <td className="image-cell" style={{padding: 0}}>
                            {row["FRONT IMAGE"] ? (
                              <div 
                                ...
                                style={{height: '100%'}}
                              >
                                <a href={row["FRONT IMAGE"]} target="_blank" rel="noopener noreferrer" style={{display: 'block', height: '100%'}}>
                                  <img
                          ...
                          <td className="image-cell" style={{padding: 0}}>
                            {row["BACK IMAGE"] ? (
                              <div 
                                ...
                                style={{height: '100%'}}
                              >
                                <a href={row["BACK IMAGE"]} target="_blank" rel="noopener noreferrer" style={{display: 'block', height: '100%'}}>
                                  <img
                          ...
                          <td className="image-cell" style={{padding: 0}}>
                            {row["SIDE IMAGE"] ? (
                              <div 
                                ...
                                style={{height: '100%'}}
                              >
                                <a href={row["SIDE IMAGE"]} target="_blank" rel="noopener noreferrer" style={{display: 'block', height: '100%'}}>
                                  <img
                          ...
                          <td className="image-cell" style={{padding: 0}}>
                            {row["PATTERN IMAGE"] ? (
                              <div 
                                ...
                                style={{height: '100%'}}
                              >
                                <a href={row["PATTERN IMAGE"]} target="_blank" rel="noopener noreferrer" style={{display: 'block', height: '100%'}}>
                                  <img
...
const DocketSheet = ({ selectedData }) => {
  ...
  return (
    <div className="printable-sheet" style={{backgroundColor: '#ffffff'}}>
      ...
      <table className="table" style={{border: '1px solid #000'}}>
        <tbody>
          {paddedData.map((row, i) => (
            <tr key={i}>
              <td className="h-number">{row["H-NUMBER"] || ""}</td>
      ...
      <div className="delivery-info" style={{color: 'red'}}>
        Delivery Date: {formatDate(selectedData[0]?.["XFACT DD"] || "")}
      </div>

      <div className="image-section" style={{display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '0', marginBottom: '3mm', overflow: 'hidden', border: '1px solid #000'}}>
        {Array.from({length: 6}).map((_, i) => (
          <div key={i} style={{overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '35mm'}}>
      ...
      <table className="table" style={{border: '1px solid #000'}}>
        ...
        <tbody>
          {paddedData.map((row, i) => (
            <tr key={i}>
              <td className="po-number" style={{color: 'red'}}>{row["PO NUMBER"] || ""}</td>
              <td>{row["STYLE NUMBER"] || ""}</td>
              <td className="main-data">{row["COLOUR"] || ""}</td>
              <td>{row["DEPARTMENT"] || "-"}</td>
              <td>{row["TOTAL UNITS"] || ""}</td>
              <td className="h-number" style={{color: 'red'}}>{row["H-NUMBER"] || ""}</td>
              <td>{row["TYPE"] || ""}</td>
              {i === 0 && (
